...
class REINFORCELogger(Logger):
    ...
    def build_experiment_info_format(self):
        self.experiment_info_format = '|{0:^9}|'
        self.experiment_info_format += '{1:^14}|'
        self.experiment_info_format += '{2:^10}|'
        self.experiment_info_format += '{3:^10}|'
        self.experiment_info_format += '{4:^10}|'
        self.experiment_info_format += '%-10.2f|'
        self.experiment_info_format += '%-10s|'
        self.experiment_info_format += '%-3s|'
